        ...
        <div class="row">
            ...
            <div id="main" class="col-md-9">
                ...
                <div class="store-filter clearfix">
                    <div class="pull-left">
                        <h3>Kết quả tìm kiếm cho từ khoá "${keyword }"</h3>
                    </div>
                    <div class="pull-right">
                        <ul class="store-pages">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li><a
                                            href="${contextPath }/tim-kiem/${StringUtil.makeSlug(cat.name)}-${cat.id}/${status_search }/${keyword}/page-${page-1}"><i
                            ...
                            <c:forEach begin="1" end="${sumPage }" var="i">
                                ...
                                <a
                                        href="${contextPath }/tim-kiem/${StringUtil.makeSlug(cat.name)}-${cat.id}/${status_search }/${keyword}/page-${i}">
                                    <li
                                            class="${active }">${i}</li>
                                </a>
                            </c:forEach>
