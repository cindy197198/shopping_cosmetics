        ...
        <div class="row">
            ...
            <div id="main" class="col-md-9">
                    ...
                    <div class="pull-right">
                        <ul class="store-pages">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li><a
                                            href="${contextPath }/tim-kiem/${property_search}/${keyword}/page-${page-1}"><i
                            ...
                            <c:forEach begin="1" end="${sumPage }" var="i">
                                ...
                                <a
                                        href="${contextPath }/tim-kiem/${property_search}/${keyword}/page-${i}">
                                    <li
                                            class="${active }">${i}</li>
                                </a>
                            </c:forEach>
                ...
                <div id="store">
                    <!-- row -->
                    <div class="row">
                        <c:forEach items="${listProduct }" var="obj" varStatus="status" begin="${offset }"
                                   end="${offset+8 }">
                            <!-- Product Single -->
