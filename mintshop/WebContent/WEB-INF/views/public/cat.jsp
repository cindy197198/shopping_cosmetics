        ...
        <div class="row">
            ...
            <div id="aside" class="col-md-3">
                ...
                <div class="aside header-search">
                    ...
                    <form action="${contextPath }/tim-kiem/${StringUtil.makeSlug(cat.name)}-${cat.id}"
                          method="post">
                        <input class="input search-input" type="text"
                               placeholder="Nhập từ khoá" name="keyword"> <select
                ...
                <div class="store-filter clearfix">
                    <div class="pull-left">
                        ...
                        <div class="sort-filter">
                            <form
                                    action="${contextPath }/danh-muc/${StringUtil.makeSlug(cat.name)}-${cat.id}"
                                    method="post">
                                <span class="text-uppercase">Sắp xếp theo:</span> <select
                                    class="input" name="status-order" style="width: 200px;">
                                <option value="1">Mới nhất</option>
                                <c:choose>
                                    <c:when test="${status_order==2 }">
                                ...
                                <c:choose>
                                    <c:when test="${status_order==3 }">
                                        <option value="3" selected="selected">Giá: Từ cao đến thấp</option>
                                    </c:when>
                                    <c:otherwise>
                                ...
                                <c:choose>
                                    <c:when test="${status_order==4 }">
                                        <option value="4" selected="selected">Giá: Từ thấp đến cao</option>
                                    </c:when>
                                    <c:otherwise>
                    ...
                    <div class="pull-right">
                        <ul class="store-pages">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li><a
                                            href="${contextPath }/danh-muc/${StringUtil.makeSlug(cat.name)}-${cat.id}/${status_order }/page-${page-1}"><i
                            ...
                            <c:forEach begin="1" end="${sumPage }" var="i">
                                ...
                                <a
                                        href="${contextPath }/danh-muc/${StringUtil.makeSlug(cat.name)}-${cat.id}/${status_order }/page-${i}">
