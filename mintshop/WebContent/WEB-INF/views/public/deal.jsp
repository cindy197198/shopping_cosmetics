        ...
        <div class="row">
            ...
            <div id="aside" class="col-md-3">
                ...
                <div class="aside header-search">
                    ...
                    <form
                        action="${contextPath }/danh-muc/${cat.name}-${cat.id}/tim-kiem"
                        method="post">
                        <input class="input search-input" type="text"
                            placeholder="Nhập từ khoá"> <select
                    ...
                    <div class="pull-right">
                        <ul class="store-pages">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li><a href="${contextPath }/giam-gia/${status_order }/page-${page-1}"><i
                            ...
                            <c:forEach begin="1" end="${sumPage }" var="i">
                                ...
                                <a href="${contextPath }/giam-gia/${status_order }/page-${i}">
