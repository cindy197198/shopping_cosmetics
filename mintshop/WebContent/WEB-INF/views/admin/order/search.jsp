                        ...
                        <select class="form-control" name="property-search">
                            ...
                            <c:choose>
                                <c:when test="${property_search==2 }">
                                    <option value="2" selected="selected">Địa chỉ</option>
                                </c:when>
                                <c:otherwise>
        ...
        <div class="panel-body">
            ...
            <nav class="text-center" aria-label="...">
                <ul class="pagination">
                    ...
                    <li class="${previous}"><a
                            href="${contextPath}/admincp/order/tim-kiem/${property_search }/${keyword }/page-${page-1}"
                    ...
                    <c:forEach begin="1" end="${sumPage }" var="i">
                        ...
                        <li class="${active }"><a
                                href="${contextPath}/admincp/order/tim-kiem/${property_search }/${keyword }/page-${i}">${i}</a>
                        </li>
                    </c:forEach>
                    <c:choose>
