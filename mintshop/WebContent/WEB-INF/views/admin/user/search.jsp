...
<div class="content-box-large">
    <div class="row">
        <div class="panel-heading">
            <div class="panel-title ">${totalRow } kết quả tìm kiếm cho từ
                khoá "${keyword }"
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4">
                <div class="input-group form">
                    <input type="text" class="form-control" placeholder="Search..."
                           value="${keyword }" name="keyword"/> <span
        ...
        <div class="panel-body">
            ...
            <nav class="text-center" aria-label="...">
                <ul class="pagination">
                    ...
                    <li class="${previous}"><a
                            href="${contextPath}/admincp/user/tim-kiem/${keyword }/page-${page-1}"
                    ...
                    <c:forEach begin="1" end="${sumPage }" var="i">
                        ...
                        <li class="${active }"><a
                                href="${contextPath}/admincp/user/tim-kiem/${keyword }/page-${i}">${i}</a></li>
                    </c:forEach>
                    <c:choose>
