...
<div class="content-box-large">
    ...
    <div class="row">
        <div class="col-md-6">
            <a href="${contextPath }/admincp/product/add" class="btn btn-success"><span
        ...
        <div class="panel-body">
                ...
                <c:forEach items="${listProduct }" var="objproduct">
                    ...
                    <tr class="odd gradeX">
                        ...
                        <td class="center text-center" width="18%"><a
                                href="${urlEdit }" title="" class="btn btn-primary"><span
            ...
            <nav class="text-center" aria-label="...">
                <ul class="pagination">
                    ...
                    <li class="${previous}"><a
                            href="${contextPath}/admincp/product/${page-1}"
                    ...
                    <c:forEach begin="1" end="${sumPage }" var="i">
                        ...
                        <li class="${active }"><a
                                href="${contextPath}/admincp/product/${i}">${i}</a></li>
                    </c:forEach>
                    <c:choose>
                    ...
                    <li class="${next }"><a
                            href="${contextPath}/admincp/product/${page+1}" aria-label="Next"><span
