                ...
                <div class="box">
                    <div class="content-wrap">
                        <img width="100px" height="100px" class="img-circle"
                             src="${contextPath}/resources/admin/images/icon-180x180.png">
                        <h6>Đăng nhập</h6>
                        <c:if test="${param['msg'] eq 'error' }">
                            <p style="font-style: italic;color: red;">Sai tên đăng nhập hoặc mật khẩu</p>
                        </c:if>
                        <form action="${contextPath }/admincp/admin-login" method="post">
